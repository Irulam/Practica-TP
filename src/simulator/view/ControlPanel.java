...
public class ControlPanel extends JPanel implements  SimulatorObserver{
	...
	protected void changeLaws() {
		Factory<ForceLaws> glf = _ctrl.getGravityLawsFactory();
		ArrayList<ForceLaws> possible = new ArrayList<>();
		for (JSONObject jo : glf.getInfo()) {
			possible.add(glf.createInstance(jo));
		}
					
		JSONObject info = (JSONObject) JOptionPane.showInputDialog(this, "Select gravity laws to be used.", "Gravity Laws Selector",
		JOptionPane.PLAIN_MESSAGE, null, possible.toArray(), fLawsDesc);
